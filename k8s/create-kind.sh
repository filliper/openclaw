...
#
# Usage:
#   ./k8s/create-kind.sh                    # Create with auto-detected engine
#   ./k8s/create-kind.sh --provider podman   # Force podman
#   ./k8s/create-kind.sh --name mycluster    # Custom cluster name
#   ./k8s/create-kind.sh --delete             # Delete the cluster
#
# After creation, deploy with:
#   export <PROVIDER>_API_KEY="..." && ./k8s/deploy.sh
# ============================================================================
...
echo ""
echo ""
echo "  export <PROVIDER>_API_KEY=\"...\" && ./k8s/deploy.sh"
echo ""
